// Thanks to https://github.com/nk2028/opencc-js
// MIT License (c) 2020 Ngiox Khyen 2028 Project
// Slightly Modefied by BillZhou233
...
const OpenCC = {
	...
	async _load_dict(s, type) {
		const DICT_ROOT = 'https://unpkg.com/opencc-data@1.0.4/data/',
			DICT_FROM = {
	...
	HTMLConverter2(convertFunc, startNode) {
		function convert() {
